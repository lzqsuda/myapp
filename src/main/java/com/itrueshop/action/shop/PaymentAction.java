...
import com.itrueshop.bean.TenpayConfig;
import com.itrueshop.bean.SystemConfig.StoreFreezeTime;
import com.itrueshop.bean.TenpayConfig.TenpayType;
...
import com.itrueshop.entity.PaymentConfig.PaymentConfigType;
...
public class PaymentAction extends BaseShopAction {
	...
	public String gateway() throws Exception {
		...
		if (paymentType == PaymentType.recharge) {
			...
			if (order.getPaymentStatus() == com.itrueshop.entity.Order.PaymentStatus.paid) {
