		...
		<form id="listForm" action="reship!list.action" method="post">
			<div class="operateBar">
				...
				<select name="pager.property">
					<option value="reshipSn" <#if pager.property == "reshipSn">selected="selected" </#if>>
						退货编号
					</option>
			...
			<table class="listTable">
				...
				<#list pager.list as list>
					<tr>
						...
						<td>
							<a href="reship!view.action?id=${list.id}" title="查看">[查看]</a>
						</td>
					</tr>
				</#list>
			</table>
			<#if (pager.list?size > 0)>
				<div class="pagerBar">
					<input type="button" class="deleteButton" url="reship!delete.action" value="删 除" disabled hidefocus="true" />
