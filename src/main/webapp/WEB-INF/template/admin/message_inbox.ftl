...
<body class="list">
	<div class="body">
		<div class="listBar">
			<h1><span class="icon">&nbsp;</span>收件箱&nbsp;<span class="pageInfo">总记录数: ${pager.totalCount}(共${pager.pageCount}页)</span></h1>
		</div>
		<form id="listForm" action="message!inbox.action" method="post">
			<div class="operateBar">
				...
				<select name="pager.property">
					<option value="fromMember.username" <#if pager.property == "fromMember.username">selected="selected" </#if>>
						发件人
					</option>
			...
			<table class="listTable">
				...
				<#list pager.list as list>
					<tr>
						...
						<td>
							<a href="message!reply.action?id=${list.id}">[回复]</a>
						</td>
					</tr>
